...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	NSString *URLScheme = [NSString stringWithFormat:@"ericom://http://localhost:%@/rdp.rdp", port];
	...
	if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad) {
	    ...
	    //splitViewController.delegate = (id)(navigationController.topViewController.tabBarController);
		splitViewController.delegate = (id)[splitViewController.viewControllers objectAtIndex:0];
	}
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
	...
	[VCLXMLRPC isConnectedToInternetShowMessage:YES];
}
